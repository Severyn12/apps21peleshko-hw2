...
public class LinkedListTest {
    ...
    public void addTest(){
        ...
        assertEquals(nwLinkedList_5.getNodeAmount(),3);
        ...
        assertEquals(nwLinkedList_6.getNodeAmount(),5);
    ...
    public void otherFunctionsTest(){
        ...
        assertEquals(nwLinkedList_4.getNodeAmount(),2);
